  ...
  return (
    <div className="flex flex-col justify-center items-center mt-28 gap-4 mx-4 lg:mx-32 m-12">
      ...
      <div className="flex flex-col gap-6 mt-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 px-16 rounded-3xl py-7 m-5 border-[#EEEEEE] border">
      ...
      <div className="flex justify-around rounded-xl bg-[#F7F7F7] w-full  items-center m-4 mx-8 p-5 ">
        <div className="flex flex-col gap-3">
          <h2 className="text-[28px] font-medium leading-6">
