      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
         <div className="flex  gap-2">
           ...
           <div className="flex justify-center  flex-col flex-wrap">
             <div className="mb-6 relative font-small text-3xl sm:text-4xl md:text-5xl">
               <h2 className="flex flex-wrap  gap-2">
                 We Design 
               
                 <div className="relative w-12 h-12 flex-wrap gap-2">
                 <Image
       ...
       <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="flex items-start gap-2 "> 
          ...
          <div className="flex justify-center flex-col flex-row">
            <div className="relative font-medium text-3xl sm:text-4xl md:text-5xl lg:pt-[145px] ">
              <h2 className="flex flex-wrap gap-2 ">
                <span className="whitespace-nowrap"> Outsource your projects to</span>  our expert
                <div className="relative w-12 h-12 flex-wrap gap-2">
                ...
                <Image
                    ...
                    width={48}
                    height={48}
                    className="object-cover rounded-xl p-1 transform rotate-[-10deg]"
                  />
                </div>
                <span>team</span>
              </h2>
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Our expert team is ready to handle your projects withs precision, delivering high-quality solutions on time. We become an extension of your team, ensuring seamless collaboration.
            </p>
          </div>
        </div>
      </div> 
